...
EXPOSE 8080
EXPOSE 9090
COPY --from=builder --chown=app:app /home/gradle/poc-java11-service/build/libs/poc-java11-service-0.1.1-SNAPSHOT.jar /home/app/
WORKDIR /home/app
...
CMD java $ARGS -XX:+PrintFlagsFinal -Dspring.profiles.active=from-docker \
         ...
         -jar poc-java11-service-0.1.1-SNAPSHOT.jar
